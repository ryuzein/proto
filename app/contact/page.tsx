...
console.log("Lanyard3D Loaded");
console.log("Rendering Lanyard3D Component");

const Contact = () => {
  useEffect(() => {
    document.title = "Contact | Romadhon Aji Satrya"
  }, [])
  const formRef = useRef(null);
  
  const scriptURL = 'https://script.google.com/macros/s/AKfycbwaUxMzM04oXHbcKOgnLiTV4Iskh4LOuFaQs5Zu_KF7SLe3CxRC3aI9HDsHkzd-MSX_/exec'
            ...
            <div className="flex flex-col md:flex-row items-start md:items-start pt-6 md:space-x-20 space-y-6 md:space-y-0">
              <div className="flex flex-col space-y-1">
                ...
                <div className="py-5 items-start flex flex-col space-y-3">
                  <span><i className="fa-solid fa-envelope fa-lg"></i>&nbsp; romaaji.id@gmail.com</span>
                  <span><i className="fa-solid fa-location-dot fa-lg"></i>&nbsp; Madiun, Indonesia</span>
                </div>
                <div className="absolute top-[-120px] left-[170px] transform -translate-x-1/2 hidden md:block">
                  ...
                  <div className="grid grid-cols-2 gap-x-3 gap-y-6 w-full">
                    <div className="col-span-1">
                      <div className="space-y-1.5">
                        ...
                        <Input type="text" placeholder="Romadhon" name="nama" required
                        />
                      </div>
                    </div>
                    <div className="col-span-1">
                      <div className="space-y-1.5">
                        ...
                        <Input type="text" placeholder="Aji" name="last_name" required />
                      </div>
                    </div>
